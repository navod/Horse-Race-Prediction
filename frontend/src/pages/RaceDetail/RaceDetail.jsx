...
import { horse1, jockey1, raceResultBackground } from "../../assets";
  ...
  return (
    <div className={`mt-20`}>
      ...
      <div className={`${styles.paddingX}`}>
        <div className="flex items-center gap-3 mt-10">
          ...
          <div className="flex flex-col">
            <h2 className="capitalize font-bold text-black text-lg">
              WILLIAM HILL DOUBLE YOUR ODDS RACING LEAGUE RACE THIRTY-SIX
              (HANDICAP) (3)
            </h2>
            <span className="text-sm text-black font-semibold">
              Newcastle - Thursday 01 February 2024, 09:30
            </span>
          </div>
        </div>
        ...
        <div className="bg-[#F5F5F5] rounded-lg py-8 px-5 flex flex-col gap-4 mt-10">
          ...
          <div className="flex justify-between">
            ...
            <div className="flex gap-16">
              ...
              <span className="text-sm ">£25770</span>
            </div>
        ...
        <div>
          <div className="w-1/4 flex-col flex gap-2 shadow-md border-2 rounded-2xl py-4 px-4 border-[#D9D9D9]">
            ...
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-[#FFA447] rounded-full flex justify-center items-center">
                <img src={horse1} width={40} />
              </div>
              <div className="flex flex-col gap-[-1]">
                <span className="font-semibold text-lg">Kingsholm(IRE)</span>
                <span className="text-[#D9D9D9] text-sm italic">
                  Last Run 35 days ago
                </span>
              </div>
            </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex gap-2">
                    ...
                    <span className="font-bold text-sm">Jack Mitchell</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-sm">Trainer</span>:
                    <span className="font-bold text-sm">James Fanshawe</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="font-bold text-sm">
                    JQatar Racing, D.Howden &amp;amp; D.Redvers
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="relative rounded-md mt-2 items-center shadow-md cursor-pointer border-2 hover:bg-[#E9E8EB] border-[#40A2D8] justify-center flex px-2 py-2">
              <span className="font-bold  text-[#0B60B0]">
                Bet your luck..!
              </span>
              <MdKeyboardArrowDown
